...
export const swappedHands = new TriggerItem(
    `^(?:You exchange the contents of your hands and begin wielding ([\\w\\W]+)? in your left hand and ([\\w\\W]+)? in your right.)|(?:You shift ([\\w\\W]+)? from your (right|left) to (right|left) hand.)$`,
