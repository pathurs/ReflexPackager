    ...
    function () {
        ...
        if (client.tradeskillmanager.transmutation.running) {
            if (client.tradeskillmanager.transmutation.queue.length > 0) {
                // display_notice(`Tradeskill Manager: Transmutation Queue: ${client.tradeskillmanager.transmutation.queue.join(', ')}`, '#00FF00');
                ...
                display_notice(`Tradeskill Manager: Transmutation Complete!`, '#00FF00');
