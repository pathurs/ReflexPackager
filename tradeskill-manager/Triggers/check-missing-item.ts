...
import { TradeskillManagerClient, HarvestingEnvironmentDictionary, GatheringEnvironmentDictionary, ExtractingEnvironmentDictionary } from '../tradeskill-manager';
    ...
    [
        new ExecuteScriptAction(
            function (args: TriggerFunctionArgs) {
                ...
                if (client.tradeskillmanager.harvesting.running || client.tradeskillmanager.extracting.running || client.tradeskillmanager.gathering.running) {
                    gag_current_line();
                }
                ...
                const inExtracting = (<string[]>(client.tradeskillmanager.extracting.environments[<keyof ExtractingEnvironmentDictionary>environment] || [])).includes(item);
                ...
                if (!inHarvesting && !inExtracting && !inGathering) {
