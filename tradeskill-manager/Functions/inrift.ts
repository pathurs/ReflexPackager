...
import { TradeskillManagerClient, ExtractingNamesDictionary, GatheringNamesDictionary, HarvestingNamesDictionary, ButcheringNamesDictionary, InkmillingNamesDictionary } from '../tradeskill-manager';
...
export const inrift = new FunctionItem(
    ...
    function (args: TriggerFunctionArgs) {
        ...
        else if (itemNameMatch in client.tradeskillmanager.extracting.names) {
            item = client.tradeskillmanager.extracting.names[<keyof ExtractingNamesDictionary>itemNameMatch];
        }
